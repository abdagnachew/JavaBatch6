...
public class MethodsReturningValue {
	...
	public static void main(String[] args) {
		...
		//create a string and based on the length of ther string
		...
		System.out.println("------------");
		// compare 2 numbers and then we identify whether largest n
String str1="Hi";
char character =str1.charAt(0);
System.out.println(str1);

		Methods obj=new Methods();
		// int num=obj.isLarger(10,20); CE Since isLarger does not return value
