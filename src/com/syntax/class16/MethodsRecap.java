...
public class MethodsRecap {
	...
	// create a method that will accept array of intergers and return max element
	// from that array
	...
	// create a method that will accept a String and return each wrod from a String
